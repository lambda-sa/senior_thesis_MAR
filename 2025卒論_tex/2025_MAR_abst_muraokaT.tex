...
In particular, Dean et al. proposed the "3GMAR" method, which eliminates the winch and minimizes relative velocity .
...
To rendezvous with the helicopter in MAR, the parafoil must arrive at a specific altitude and velocity and perform a "Wind-Up Approach" for stability. In this study, the trajectory is planned in three phases in Fig. \ref{fig:para_traj_plan}. 
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\linewidth]{画像/plannning_phase_dubins.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\linewidth]{画像/newVF_image.png}
...
\bibitem{nasa} The National Aeronautics and Space Administration, The X-38 prototype of the Crew Return Vehicle is suspended under
its giant 7,500-square-foot parafoil during its eighth free flight on Thursday, December 13, 2001, from
<https://www.nasa.gov/image-detail/amf-ec01-0339-146/>.
